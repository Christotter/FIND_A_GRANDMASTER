...
gm1 = Grandmaster.new(fide_id: 12345, elo_rating: 2521, country: 'Malta', bio: bio1, language: 'french', user: user1)
gm1.save!
gm2 = Grandmaster.new(fide_id: 1111, elo_rating: 2000, country: 'Georgia', bio: bio2, language: 'english', user: user2)
gm2.save!
gm3 = Grandmaster.new(fide_id: 2222, elo_rating: 2700, country: 'Denmark', bio: bio3, language: 'english', user: user3)
gm3.save!
gm4 = Grandmaster.new(fide_id: 43224, elo_rating: 2335, country: 'Georgia', bio: bio4, language: 'english', user: user4)
gm4.save!
gm5 = Grandmaster.new(fide_id: 574221, elo_rating: 2540, country: 'Denmark', bio: bio5, language: 'english', user: user5)
gm5.save!
gm6 = Grandmaster.new(fide_id: 57422, elo_rating: 2543, country: 'Armenia', bio: bio6, language: 'english', user: user6)
gm6.save!
gm7 = Grandmaster.new(fide_id: 57434, elo_rating: 2560, country: 'Spain', bio: bio7, language: 'english', user: user7)
gm7.save!
